...
export default function Plataforma({ plataformas }: Props) {
  ...
  const ORDEM = ['whatsapp', 'delivery_much', 'balcao', 'aiqfome', 'ifood', 'amoofertas']
  ...
  return (
    <div
      ...
      style={{
        ...
        overflow: "hidden",
        background: `
          radial-gradient(900px 200px at 15% -10%, rgba(45,207,190,0.12) 0%, rgba(45,207,190,0.06) 35%, rgba(45,207,190,0.04) 60%),
