...
export type PlataformaRow = {
  ...
  valor: number;
  pct: number;
  accent: "purple" | "blue" | "green" | "red" | "orange" | "pink";
};

function accentMap(accent: PlataformaRow["accent"]) {
  const map = {
    purple: {
      bd: "rgba(171, 95, 255, 0.42)",
      bdHover: "rgba(171, 95, 255, 0.60)",
      glow: "rgba(171,95,255,0.22)",
      innerTop: "rgba(255,255,255,0.08)",
      innerBot: "rgba(0,0,0,0.22)",
      tag: "rgba(171, 95, 255, 0.95)",
    },
    blue: {
    ...
    pink: {
      bd: "rgba(250,4,101,0.42)",
      bdHover: "rgba(250,4,101,0.62)",
      glow: "rgba(250,4,101,0.20)",
      innerTop: "rgba(255,255,255,0.08)",
      innerBot: "rgba(0,0,0,0.22)",
      tag: "rgba(250, 4, 101, 0.95)",
    },
  } as const;
