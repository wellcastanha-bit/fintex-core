            ...
            return (
              <button
                ...
                style={{
                  ...
                  padding: '10px 0',
                  borderRadius: 12,
                  border: active ? '1px solid rgba(79,220,255,0.35)' : '1px solid transparent',
                  background: active ? 'rgba(79,220,255,0.12)' : 'transparent',
                  color: active ? '#9feeff' : 'rgba(227,236,248,0.46)',
                  fontSize: 13,
                  fontWeight: 700,
              ...
              >
                ...
                <div
                  style={{
                    ...
                    border: '1px solid rgba(79,220,255,0.14)',
                    color: '#9feeff',
                    fontSize: badgeFs,
                    fontWeight: 700,
